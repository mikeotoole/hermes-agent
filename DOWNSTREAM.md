...
- Packaged downstream runtime head: `54170df967a3fceee0590a537c2e7d688de57b11`, tree `f21033cb8726cfd43109cf6f4f0a0ea9333ebcb4`.
- Candidate branch: `release/lagoon-2026.08.02.1-minimal-v2`.
- Candidate tag: `lagoon/2026.08.02.1`.
- Candidate behavior: ordered interim commentary during tool calls, cumulative-boundary preservation, reconnect survival in Desktop and TUI, and AgentCTRL compatibility.
- Runtime patch: one squashed commentary/reconnect commit. Its source provenance is:
...
- Explicit exclusions: updater EOL handling, broad macOS/runtime portability, unrelated timing/concurrency/test-harness stabilization, and compaction-queue behavior.
